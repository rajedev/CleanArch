        ...
        setContent {
            ...
            ClearArchTheme {
                Scaffold(topBar = {
                    ...
                    MainScreen(Modifier.padding(innerPadding))/*Greeting(
                        feedViewModel,
...
val dataInfo = mutableListOf(
    ListData("John", 1990),
    ListData("Doe dfsdf dsf sdf dfds fds dfds fdfd  dfsd sdfdsf ds dfds d fdsfdDoe dfsdf dsf sdf dfds fds dfds fdfd  dfsd sdfdsf ds dfds d fdsfdDoe dfsdf dsf sdf dfds fds dfds fdfd  dfsd sdfdsf ds dfds d fdsfdDoe dfsdf dsf sdf dfds fds dfds fdfd  dfsd sdfdsf ds dfds d fdsfd", 1995),
    ListData("Jane", 2000),
    ...
    Row(
        ...
        Text(
            ...
            modifier = Modifier
                ...
                .weight(1f)
                .padding(end = 10.dp),
            style = TextStyle(fontSize = 15.sp, fontWeight = FontWeight.SemiBold, fontStyle = FontStyle.Normal,
